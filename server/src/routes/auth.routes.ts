...
router.post('/forgot-password', authLimiter, forgotPasswordRules, validate, auth.forgotPassword);
router.post('/reset-password', authLimiter, resetPasswordRules, validate, auth.resetPassword);
router.post('/change-password', requireAuth, changePasswordRules, validate, auth.changePassword);
